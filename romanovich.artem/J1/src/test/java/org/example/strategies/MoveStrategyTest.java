...
class MoveStrategyTest {
  ...
  private void testUseStrategyWithCommand(String command, MoveStrategy strategy1111111111111111111111111111111111111) throws UnknownCommandException {
    processor.useStrategy(command);
    assertNotNull(strategy1111111111111111111111111111111111111);
    strategy1111111111111111111111111111111111111.move();
  }
